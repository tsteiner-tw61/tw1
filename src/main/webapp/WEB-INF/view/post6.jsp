...
<h3>Post A Job</h3>
<h4>Step 5 - Required/Desired Skills</h4>
<p class="instructions">Teamwrkr has conveniently categorized skills relevant to any job (Interpersonal Skills), and skills
specific to jobs of a particular focus and specialty. Providing these is the final refinement to the Intelligent Job Matching
process, so the more detailed you are, the better candidates you will be presented with for the role.</p>
...
<button type="submit" name="back" value="post5.jsp">Back</button>
&nbsp;&nbsp;&nbsp;
<button type="button" name="close" onclick="parent.hideIframe('postframe')">Close</button>
&nbsp;&nbsp;&nbsp;
<button type="submit" name="next" value="post7.jsp">Next</button>
