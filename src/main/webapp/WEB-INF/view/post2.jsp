...
<h3>Post A Job</h3>
<h4>Step 1 - Provide A Job Title/Description</h4>
<p class="instructions">Job titles should be roles generally understood without much explanation by members of the freelance community.
A short description is to be included only to provide more clarity about the role and not for rates and/or other terms/timelines
of the position. Subsequent slides will address these concerns.</p>
...
<a href="/tw1/post1.jsp"><button type="button" name="back">Back</button></a>
&nbsp;&nbsp;&nbsp;
<button type="button" name="close" onclick="parent.hideIframe('postframe')">Close</button>
&nbsp;&nbsp;&nbsp;
<button type="submit" name="next" value="post3.jsp">Next</button>
