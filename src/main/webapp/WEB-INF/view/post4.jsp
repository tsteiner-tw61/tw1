...
<h3>Post A Job</h3>
<h4>Step 3 - Start Date</h4>
<p class="instructions">Teamwrkr requires that a concrete start date be provided for a project to be posted on the site.
Matching this date with a freelancer's known availability within the application allows Intelligent Job Matching to present
to you only candidates who meet your needs.</p>
...
<button type="submit" name="back" value="post3.jsp">Back</button>
&nbsp;&nbsp;&nbsp;
<button type="button" name="close" onclick="parent.hideIframe('postframe')">Close</button>
&nbsp;&nbsp;&nbsp;
<button type="submit" name="next" value="post5.jsp">Next</button>
