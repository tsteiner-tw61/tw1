...
<h3>Post A Job</h3>
<h4>Step 2 - Select Job Focus/Specialty</h4>
<p class="instructions">Teamwrkr uses job focus and specialty data as key components of its Intelligent Job Matching algorithm.
At the current time, categories are limited, but we will be adding more with each new application release version.</p>
...
<button type="submit" name="back" value="post2.jsp">Back</button>
&nbsp;&nbsp;&nbsp;
<button type="button" name="close" onclick="parent.hideIframe('postframe')">Close</button>
&nbsp;&nbsp;&nbsp;
<button type="submit" name="next" value="post4.jsp">Next</button>
