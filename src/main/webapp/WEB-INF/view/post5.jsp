...
<p class="instructions">Several options are available with respect to how you wish to pay the freelancer when the job is
completed to your satisfaction. We ask you either provide a time estimate, coupled with an hourly rate, or a fixed total project rate
due upon completion of work. If you aren't sure what is a fair rate for this project Teamwrkr can help! Selecting 'I Don't Know' for
compensation will trigger a request to a member of the Teamwrkr analysis team to contact you (generally within 24 hours).</p>
...
<button type="submit" name="back" value="post4.jsp">Back</button>
&nbsp;&nbsp;&nbsp;
<button type="button" name="close" onclick="parent.hideIframe('postframe')">Close</button>
&nbsp;&nbsp;&nbsp;
<button type="submit" name="next" value="post6.jsp">Next</button>
...
<td class="progresstd" style="width: 50px; opacity: 75%;"></td>
<td class="progresstd" style="width: 50px; opacity: 75%;"></td>
<td class="progresstd" style="width: 50px;"></td>
<td class="progresstd" style="width: 50px;"></td>
</tr>
</table>
Step #4 of 6
